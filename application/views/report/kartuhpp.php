        ...
        <?php
          foreach ($dataPesanan as $data) {
            ...
            <tr>
              ...
              <td><a href="<?php echo base_url('/Report/LihatKartuHPP/').$data->id?>"> <button class="btn btn-info detail-dataPosisi" data-id="<?php echo $data->id; ?>"><i class="glyphicon glyphicon-search"></i> Lihat Kartu HPP</button></a></td>
            </tr>
            <?php
          }
        ?>
