<?php
  foreach ($dataPesanan as $data) {
    ...
    <tr>
      ...
      <td><?php echo $data->dp==0 ?  "Belum diproses" : "Sedang diproses"; ?></td>
      <td class="text-center" style="min-width:230px;">
        ...
        <button class="btn btn-danger konfirmasiHapus-pesanan" data-id="<?php echo $data->id; ?>" data-toggle="modal" data-target="#konfirmasiHapus"><i class="glyphicon glyphicon-remove-sign"></i> Delete</button>
      </td>
    </tr>
    <?php
  }
