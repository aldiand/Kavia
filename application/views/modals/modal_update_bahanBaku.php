  ...
  <h3 style="display:block; text-align:center;">Update Data BahanBaku</h3>
      <form method="POST" id="form-update-bahanBaku">
        ...
        <div class="input-group form-group">
          ...
          <input type="number" class="form-control" placeholder="harga" name="harga" value="<?php echo $dataBahanBaku->harga; ?>" aria-describedby="sizing-addon2">
        </div>
        <div class="input-group form-group">
          <label  class="control-label">Jumlah</label>
          <input type="number" class="form-control" placeholder="Jumlah" name="jumlah" value="<?php echo $dataBahanBaku->jumlah; ?>" aria-describedby="sizing-addon2">
        </div>
