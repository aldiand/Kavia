      ...
      <form method="POST" id="form-update-bbp">
        ...
        <input type="hidden" name="id" value="<?php echo $dataBbp->id; ?>">
          ...
          <div class="input-group form-group">
            ...
            <input type="date" readonly="readonly" class="form-control" value="<?php echo $dataBbp->tanggal;?>" name="tanggal" aria-describedby="sizing-addon2">
          </div>
          <div class="input-group form-group">
          ...
          <div class="input-group form-group">
            <input type="hidden" class="form-control" value="<?php echo $dataBbp->jumlah;?>" name="jumlah" aria-describedby="sizing-addon2">
          </div>
